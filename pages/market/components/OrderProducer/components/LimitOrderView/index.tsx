...
import { SpotGridMarket, TokenMetadata, decimalPlacesFromTickSize, formatNumbersWithCommas, justFormatNumbersWithCommas, removeCommas } from "utils";
...
import { OrderPacket, SelfTradeBehavior, Side, getClaimSeatIx, getCreateTokenAccountInstructions } from "@ellipsis-labs/phoenix-sdk";
            ...
            <Form>
                ...
                <div className={styles.formLabelAndFieldContainerNoBottomMargin}>
                    ...
                    <span className={styles.fieldTitleContainer}>
                        <span>Size {`(${baseTokenMetadata ? baseTokenMetadata.ticker : ``})`}</span>
                    </span>
                    </Form.Label>
                    <Form.Control
