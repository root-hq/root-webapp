...
const PerformanceContainer = () => {
    ...
    const [selectedDuration, setSelectedDuration] = useState<SelectedDuration>(SelectedDuration.Day);
            ...
            <div className={styles.optionsContainer}>
                ...
                <div className={styles.durationSelectorContainer}>
                    <Button
                        ...
                        value={"24h"}
                        style={{
                            color: selectedDuration === SelectedDuration.Day ? '#ddd' : '#888',
                            fontWeight: selectedDuration === SelectedDuration.Day ? 'bold' : 'normal'
                        }}
                    >
                        24h
                    </Button>
                    <Button
                        ...
                        value={"7d"}
                        style={{
                            color: selectedDuration === SelectedDuration.Week ? '#ddd' : '#888',
                            fontWeight: selectedDuration === SelectedDuration.Week ? 'bold' : 'normal'
                        }}
                    >
                        7d
                    </Button>
                    <Button
                        ...
                        value={"1y"}
                        style={{
                            color: selectedDuration === SelectedDuration.Year ? '#ddd' : '#888',
                            fontWeight: selectedDuration === SelectedDuration.Year ? 'bold' : 'normal'
                        }}
                    >
                        1y
                    </Button>
