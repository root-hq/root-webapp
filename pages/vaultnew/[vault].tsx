...
const NewVaultPage = ({ vaultData, baseTokenMetadata, quoteTokenMetadata, vaultBalance, fillTrades, l3UiBook }: NewVaultPageProps) => {
    ...
    return(
        <Container className={styles.vaultPageContainer}>
            <Row className={styles.firstRowContainer}>
                <Col md = {6} xs = {12} className={styles.firstRow}>
                    ...
                    <div className={styles.tags}>
                        <Tag
                            ...
                            valueStyle={
                                {
                                    color: '#477df2',
                                    fontSize: windowSize[0] > 425 ? '0.9rem' : windowSize[0] > 375 ? '0.75rem' : '0.5rem',
                                    padding: '0.5rem',
