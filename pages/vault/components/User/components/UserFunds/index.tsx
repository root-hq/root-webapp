  ...
  return (
    <div className={styles.userFundsContainer}>
      <div className={styles.userFundsTitleContainer}>
        <span className={styles.userFundsTitle}>Your portfolio</span>
      </div>
        ...
        <div className={styles.userFundsDetail}>
          {quoteTokenMetadata && quoteTokenMetadata.ticker ? (
            <KeyValueComponent
              ...
              valueElement={<span>{`10,365.98`}</span>}
              valueElementStyle={{
                color: "#fff",
                fontWeight: "bold",
              }}
      ...
      <div className={styles.userProfitabilityTextContainer}>
        <KeyValueComponent
          keyElement={<span>{`Net profits`}</span>}
          keyElementStyle={{
            color: "#888",
            fontWeight: "bold",
          }}
          valueElement={<span>{`+ $11.92`}</span>}
          valueElementStyle={{
            color: "#35c674",
            fontWeight: "bold",
          }}
