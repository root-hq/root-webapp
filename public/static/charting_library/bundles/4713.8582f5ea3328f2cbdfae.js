      ...
      function h(e) {
        ...
        return s.createElement(
          Z,
          {
            ...
            id: t,
            role: n,
            className: a(c, A.item, v && A.withIcon, {
              [A.isActive]: D,
              [A.isDisabled]: b || C,
              [A.hovered]: y,
            }),
            ...
            onClick: function (e) {
              if (b) return;
              W && (0, r.trackEvent)(W.category, W.event, W.label);
              $ && $(K, e);
            ...
            onContextMenu: function (e) {
              W &&
                J &&
                (0, r.trackEvent)(W.category, W.event, `${W.label}_rightClick`);
            },
            onMouseUp: function (e) {
              if (1 === e.button && _ && W) {
                let e = W.label;
                j && (e += "_mouseWheelClick"),
                  (0, r.trackEvent)(W.category, W.event, e);
              }
            },
            onMouseOver: T,
            onMouseOut: x,
          ...
          v &&
            s.createElement("span", {
              ...
              className: a(A.icon, z && l["round-icon"], w),
              dangerouslySetInnerHTML: { __html: v },
            }),
          s.createElement(
            "span",
            { className: a(A.labelRow, d) },
            s.createElement("span", { className: a(A.label, p) }, E),
          ),
          (void 0 !== g || f) &&
            s.createElement(
              "span",
